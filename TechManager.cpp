...
bool MeatAIModule::Tech_Begin(Unit building, const Unit_Inventory &ui) {
    ...
    busy += Check_N_Upgrade( UpgradeTypes::Metabolic_Boost, building, (tech_starved || Count_Units( UnitTypes::Zerg_Larva, friendly_inventory ) == 0) && ( Stock_Units( UnitTypes::Zerg_Zergling, friendly_inventory ) > Stock_Units( UnitTypes::Zerg_Hydralisk, friendly_inventory ) || BWAPI::Broodwar->self()->getUpgradeLevel( UpgradeTypes::Zerg_Missile_Attacks ) == 3 ) );
    busy += Check_N_Upgrade( UpgradeTypes::Zerg_Melee_Attacks, building, (tech_starved || Count_Units( UnitTypes::Zerg_Larva, friendly_inventory ) == 0) && ( Stock_Units( UnitTypes::Zerg_Zergling, friendly_inventory ) > Stock_Units( UnitTypes::Zerg_Hydralisk, friendly_inventory ) || BWAPI::Broodwar->self()->getUpgradeLevel( UpgradeTypes::Zerg_Missile_Attacks ) == 3 ) );

    busy += Check_N_Upgrade( UpgradeTypes::Zerg_Missile_Attacks, building, (tech_starved || Count_Units( UnitTypes::Zerg_Larva, friendly_inventory ) == 0) && (Stock_Units(UnitTypes::Zerg_Hydralisk, friendly_inventory ) > Stock_Units( UnitTypes::Zerg_Zergling, friendly_inventory ) || BWAPI::Broodwar->self()->getUpgradeLevel( UpgradeTypes::Zerg_Melee_Attacks ) == 3) );
    ...
    busy += Check_N_Upgrade( UpgradeTypes::Chitinous_Plating, building, (tech_starved || Count_Units( UnitTypes::Zerg_Larva, friendly_inventory ) == 0) && Count_Units( UnitTypes::Zerg_Ultralisk_Cavern, friendly_inventory ) > 0 );

    busy += Check_N_Build( UnitTypes::Zerg_Lair, building, ui, (tech_starved || Count_Units( UnitTypes::Zerg_Larva, friendly_inventory ) == 0) &&
    ...
    busy += Check_N_Build( UnitTypes::Zerg_Hive, building, ui, (tech_starved || Count_Units( UnitTypes::Zerg_Larva, friendly_inventory ) == 0) &&
