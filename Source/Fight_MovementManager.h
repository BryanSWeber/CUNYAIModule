...
public:
    // Basic retreat logic
    void Retreat_Logic( const Unit & unit, const Unit & enemy, const Unit_Inventory & ui, const Inventory & inventory, const Color & color );;
    ...
    void Boids_Movement( const Unit &unit, const double &n, const Unit_Inventory &ui, const Unit_Inventory &ei, const Inventory &inventory );
    ...
    void setAlignment( Unit unit, Unit_Inventory ui );
    void setCentralize( Position pos, Inventory inventory );
    void setStutter( const Unit &unit, int n );
    void setCohesion( const Unit &unit, const Position &pos, const Unit_Inventory &ui );
    void setAttraction( const Unit &unit, const Position &pos, const Unit_Inventory &ei );
