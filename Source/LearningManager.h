...
struct LearningManager {
    ...
    "drone drone drone drone drone overlord drone drone drone pool extract drone hatch drone drone ling ling lair drone drone drone speed hydra_den ling ling lurker_tech overlord hydra hydra hydra hydra extract lurker lurker lurker lurker", // 2h lurker https://liquipedia.net/starcraft/2_Hatch_Lurker_(vs._Terran)
