...
struct Map_Inventory {
    ...
    // Returns the position of the weakest base. Friendly is true (by default) to checking -yourself- for the weakest base. Fodder is for the inclusion of fodder in that calculation.
    Position Map_Inventory::getWeakestBase(const bool &friendly = true, const bool &fodder = true) const;
    // Returns the Position of the strongest base. Friendly is true (by default) to checking -yourself- for the strongest base. Fodder is for the inclusion of fodder in that calculation.
    Position Map_Inventory::getStrongestBase(const bool &friendly = true, const bool &fodder = true) const;
