...
constexpr bool TIT_FOR_TAT_ENGAGED = false; // permits in game-tit-for-tat responses. Should be disabled for training against base AI and TEST_MODE.
constexpr bool TEST_MODE = true; // Locks in a build order and defined paramaters. Disable TRAINING_AGAINST_BASE_AI, TIT_FOR_TAT and LEARNING_MODE.
