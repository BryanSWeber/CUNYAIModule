...
public:
    ...
    static bool isCollectingForces(const UnitInventory & ui, const UnitInventory &ei); //Checks if you're preparing to attack in a given UI. Tests the % of units pathing out.
